...
const segmentum = function (options) {
  ...
  return {
    ...
    getSource: (workspaceSlug, name) => buildCall('GET', `https://segment.com/api/workspaces/${workspaceSlug}/projects/${name}/overview`),
    deleteSource: (workspaceSlug, sourceSlug) => buildCall('DELETE', `https://segment.com/api/${workspaceSlug}/madmobile/projects/${sourceSlug}`, null, [], `https://segment.com/${workspaceSlug}/sources/${sourceSlug}/settings`),
