...
const segmentum = function (options) {
  ...
  return {
    ...
    connectWarehouse: (workspaceSlug, warehouseId, data) => buildCall('POST', `https://segment.com/api/workspaces/${workspaceSlug}/warehouses/connect/${warehouseId}`, data, [], `https://segment.com/${workspaceSlug}/warehouses`)
  };
};
