...
const segmentum = function (options) {
  ...
  return {
    ...
    deleteSource: (workspaceSlug, sourceSlug) => buildCall('DELETE', `https://segment.com/api/${workspaceSlug}/projects/${sourceSlug}`, null, [], `https://segment.com/${workspaceSlug}/sources/${sourceSlug}/settings`),
